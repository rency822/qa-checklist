const issueData = [
  ...
  { label: "Missing rolloverthumbs", hasInput: true },
  { label: "Scene already live", hasInput: true },
  { label: "Wrong date tag", hasInput: true },
  { label: "Broken Photo presentation", hasInput: true },
  { label: "Thumb for imgage () are not appearing", hasInput: true },
  { label: "Images () are corrupted / in between transition", hasInput: true },
